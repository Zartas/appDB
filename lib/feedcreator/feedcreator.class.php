 ...
 * Version string.
 **/
define("FEEDCREATOR_VERSION", "AppDB V1");
...
class FeedCreator extends HtmlDescribable {
	...
	*/
	...
	function _createStylesheetReferences() {
		$xml = "";
		if (isset($this->cssStyleSheet) && $this->cssStyleSheet) $xml .=
			"<?xml-stylesheet href=\"".$this->cssStyleSheet."\" type=\"text/css\"?>\n";
		if (isset($this->xslStyleSheet) && $this->xslStyleSheet) $xml .=
			"<?xml-stylesheet href=\"".$this->xslStyleSheet."\" type=\"text/xsl\"?>\n";
		return $xml;
	}
