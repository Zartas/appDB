		...
		if($log){
            ...
            if($f){
				if(is_writable($f)){
					...
					trigger_error("<strong>Fatal Error:</strong> Couldn't write to file: '<strong>$f</strong>'<br>Please check if the path exists and is writable for the webserver or php...", E_USER_WARNING);
            	}
            }
